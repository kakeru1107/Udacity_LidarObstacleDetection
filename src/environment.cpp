...
{
    pcl::PointCloud<pcl::PointXYZI>::Ptr filteredCloud = pointProcessor.FilterCloud(inputCloud, 0.2, Eigen::Vector4f (-15, -6, -3, 1), Eigen::Vector4f ( 15, 6, 3, 1));
    
    //use original method
    std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr, pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = pointProcessor.SegmentPlane_withRansac(filteredCloud, 25, 0.3);
    
    renderPointCloud(viewer, segmentCloud.first, "obstCloud", Color(1,0,0));
    renderPointCloud(viewer, segmentCloud.second, "planeCloud", Color(0,1,0));

    //use original method
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor.Clustering_withEuclidean(segmentCloud.first, 0.53, 10, 500);
